...
from .tech_lead_answers import TECH_LEAD_ANSWERS
from .product_manager_answers import PRODUCT_MANAGER_ANSWERS
from .security_engineer_answers import SECURITY_ENGINEER_ANSWERS
...
DEFAULT_ANSWERS = {
    ...
    "I'm a Tech Lead": TECH_LEAD_ANSWERS,
    "I'm a Product Manager": PRODUCT_MANAGER_ANSWERS,
    "I'm a Security Engineer": SECURITY_ENGINEER_ANSWERS,
